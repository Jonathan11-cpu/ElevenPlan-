...
import 'tugas1_bing.dart';
import 'tugas2_bing.dart';
...
class BahasaInggrisPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> tugasList = [
      {
        'judul': 'TUGAS 1 – Simple Present Tense',
        'tanggal': '20 Agustus 2025',
        'status': 'belum',
      },
      {
        'judul': 'TUGAS 2 – Descriptive Text Writing',
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            if (tugas['judul'].contains('TUGAS 1')) {
                              Navigator.push(context, MaterialPageRoute(builder: (_) => const Tugas1BingPage()));
                            } else if (tugas['judul'].contains('TUGAS 2')) {
                              Navigator.push(context, MaterialPageRoute(builder: (_) => const Tugas2BingPage()));
                            }
                          },
                          child: Padding(
