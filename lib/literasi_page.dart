...
class _LiterasiPageState extends State<LiterasiPage> with TickerProviderStateMixin {
  final List<Map<String, dynamic>> questions = [
    {
      "story": "Di sebuah desa kecil, Ani menemukan buku harian tua milik neneknya yang berisi kisah masa kecil di zaman penjajahan.",
      "question": "Apa yang ditemukan Ani?",
      "options": ["Surat kabar", "Foto lama", "Buku harian", "Peta desa"],
      "answer": "Buku harian"
    },
    {
      "story": "Rudi membaca artikel tentang pentingnya daur ulang plastik untuk lingkungan.",
      "question": "Apa isi artikel yang dibaca Rudi?",
      "options": ["Cara membuat plastik", "Bahaya api", "Daur ulang plastik", "Cuaca ekstrim"],
      "answer": "Daur ulang plastik"
    },
    {
      "story": "Siti menulis puisi tentang keindahan hutan hujan tropis di Indonesia.",
      "question": "Tentang apa puisi yang ditulis Siti?",
      "options": ["Laut Indonesia", "Hutan hujan tropis", "Gunung berapi", "Kota besar"],
      "answer": "Hutan hujan tropis"
    },
    {
      "story": "Budi mendengarkan dongeng tentang kancil yang cerdik menipu harimau.",
      "question": "Siapa tokoh utama dalam dongeng yang didengar Budi?",
      "options": ["Harimau", "Kancil", "Singa", "Monyet"],
      "answer": "Kancil"
    },
    {
      "story": "Dina membaca surat dari temannya di luar negeri yang menceritakan salju pertama kali turun.",
      "question": "Apa yang diceritakan dalam surat itu?",
      "options": ["Festival musim panas", "Kejadian banjir", "Salju pertama", "Pohon natal"],
      "answer": "Salju pertama"
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Icon(
            Icons.arrow_back_rounded, // Changed to rounded version for better look
            color: Colors.white, // Changed to white
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          if (allAnswered) {
            ...
            if (nextIndex >= 0) {
              scrollController.animateTo(
                nextIndex * 450.0, // Adjusted for larger card height
                duration: const Duration(milliseconds: 500),
                curve: Curves.easeInOut,
              );
            }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              percentage >= 80
                  ? "Hebat! Kamu menguasai materi ini dengan sangat baik."
                  : percentage >= 60
                      ? "Kamu sudah memahami sebagian besar materi. Terus berlatih!"
                      : "Jangan menyerah! Latihan terus untuk meningkatkan pemahaman.",
