...
import 'tugas_agama_1_page.dart';
import 'tugas_agama_2_page.dart';

class AgamaPage extends StatelessWidget {
  const AgamaPage({super.key});

  @override
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> tugasList = [
      {
        'judul': 'TUGAS 1 – Sejarah Islam',
        'tanggal': '20 Agustus 2025',
        'status': 'belum',
      },
      {
        'judul': 'TUGAS 2 – Rukun Islam',
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            if (tugas['judul'].contains('TUGAS 1')) {
                              Navigator.push(context, MaterialPageRoute(builder: (_) => const TugasAgama1Page()));
                            } else if (tugas['judul'].contains('TUGAS 2')) {
                              Navigator.push(context, MaterialPageRoute(builder: (_) => const TugasAgama2Page()));
                            }
                          },
                          child: Padding(
